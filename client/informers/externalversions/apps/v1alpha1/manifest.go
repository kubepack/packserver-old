...
import (
	...
	apps_v1alpha1 "github.com/kubepack/packserver/apis/apps/v1alpha1"
	...
	v1alpha1 "github.com/kubepack/packserver/client/listers/apps/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1alpha1().Manifests(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1alpha1().Manifests(namespace).Watch(options)
			},
		},
		&apps_v1alpha1.Manifest{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *manifestInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apps_v1alpha1.Manifest{}, f.defaultInformer)
}
