...
type PackInterface interface {
	Create(*tamal.Pack) (*tamal.Pack, error)
	Update(*tamal.Pack) (*tamal.Pack, error)
	UpdateStatus(*tamal.Pack) (*tamal.Pack, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*tamal.Pack, error)
	List(opts v1.ListOptions) (*tamal.PackList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *tamal.Pack, err error)
	PackExpansion
}
...
func newPacks(c *TamalClient, namespace string) *packs {
	return &packs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *packs) Get(name string, options v1.GetOptions) (result *tamal.Pack, err error) {
	result = &tamal.Pack{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("packs").
...
func (c *packs) List(opts v1.ListOptions) (result *tamal.PackList, err error) {
	result = &tamal.PackList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("packs").
...
func (c *packs) Create(pack *tamal.Pack) (result *tamal.Pack, err error) {
	result = &tamal.Pack{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("packs").
...
func (c *packs) Update(pack *tamal.Pack) (result *tamal.Pack, err error) {
	result = &tamal.Pack{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("packs").
...
func (c *packs) UpdateStatus(pack *tamal.Pack) (result *tamal.Pack, err error) {
	result = &tamal.Pack{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("packs").
...
func (c *packs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *tamal.Pack, err error) {
	result = &tamal.Pack{}
