...
type ReleaseInterface interface {
	Create(*apps.Release) (*apps.Release, error)
	Update(*apps.Release) (*apps.Release, error)
	UpdateStatus(*apps.Release) (*apps.Release, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*apps.Release, error)
	List(opts v1.ListOptions) (*apps.ReleaseList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *apps.Release, err error)
	ReleaseExpansion
}
...
func newReleases(c *AppsClient, namespace string) *releases {
	return &releases{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *releases) Get(name string, options v1.GetOptions) (result *apps.Release, err error) {
	result = &apps.Release{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("releases").
...
func (c *releases) List(opts v1.ListOptions) (result *apps.ReleaseList, err error) {
	result = &apps.ReleaseList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("releases").
...
func (c *releases) Create(release *apps.Release) (result *apps.Release, err error) {
	result = &apps.Release{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("releases").
...
func (c *releases) Update(release *apps.Release) (result *apps.Release, err error) {
	result = &apps.Release{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("releases").
...
func (c *releases) UpdateStatus(release *apps.Release) (result *apps.Release, err error) {
	result = &apps.Release{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("releases").
...
func (c *releases) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *apps.Release, err error) {
	result = &apps.Release{}
