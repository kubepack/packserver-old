...
var usersResource = schema.GroupVersionResource{Group: "apps.kubepack.com", Version: "", Resource: "users"}

var usersKind = schema.GroupVersionKind{Group: "apps.kubepack.com", Version: "", Kind: "User"}

// Get takes name of the user, and returns the corresponding user object, and an error if there is any.
func (c *FakeUsers) Get(name string, options v1.GetOptions) (result *apps.User, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(usersResource, name), &apps.User{})
	if obj == nil {
		return nil, err
	}
	return obj.(*apps.User), err
}

// List takes label and field selectors, and returns the list of Users that match those selectors.
func (c *FakeUsers) List(opts v1.ListOptions) (result *apps.UserList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(usersResource, usersKind, opts), &apps.UserList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &apps.UserList{}
	for _, item := range obj.(*apps.UserList).Items {
...
func (c *FakeUsers) Create(user *apps.User) (result *apps.User, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(usersResource, user), &apps.User{})
	if obj == nil {
		return nil, err
	}
	return obj.(*apps.User), err
...
func (c *FakeUsers) Update(user *apps.User) (result *apps.User, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(usersResource, user), &apps.User{})
	if obj == nil {
		return nil, err
	}
	return obj.(*apps.User), err
...
func (c *FakeUsers) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(usersResource, name), &apps.User{})
	return err
}
...
func (c *FakeUsers) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &apps.UserList{})
	return err
}
...
func (c *FakeUsers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *apps.User, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(usersResource, name, data, subresources...), &apps.User{})
	if obj == nil {
		return nil, err
	}
	return obj.(*apps.User), err
