...
var packsResource = schema.GroupVersionResource{Group: "apps.kubepack.com", Version: "v1alpha1", Resource: "packs"}

var packsKind = schema.GroupVersionKind{Group: "apps.kubepack.com", Version: "v1alpha1", Kind: "Pack"}
