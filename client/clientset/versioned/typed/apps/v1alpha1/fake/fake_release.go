...
var releasesResource = schema.GroupVersionResource{Group: "apps.kubepack.com", Version: "v1alpha1", Resource: "releases"}

var releasesKind = schema.GroupVersionKind{Group: "apps.kubepack.com", Version: "v1alpha1", Kind: "Release"}
